...
### **Pluribus Netvisor VLE L1 Shell**
Pluribus Netvisor VLE L1 shell provides you with the capability to communicate with network topology managed by the Pluribus Netvisor with [VLE (Virtual Link Extension)  Service](https://techdocassets.pluribusnetworks.com/UNUM/unum510/VLE-ManageVLE.html) configured.
